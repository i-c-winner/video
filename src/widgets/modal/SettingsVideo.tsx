  ...
  function getvideo() {
    ...
    return (
      <FormControl sx={{ textAlign: "center" }}>
        ...
        >
          <FormControlLabel
            value={videoQty.disabled}
            control={<Radio />}
            label={
              <Typography variant="myText">
                {t("modal.settings.disabled")}
              </Typography>
            }
          />
          <FormControlLabel
            ...
            label={
              <Typography variant="myText">
                {t("modal.settings.low")}
              </Typography>
            }
          />
          <FormControlLabel
            value={videoQty.middle}
            control={<Radio />}
            label={
              <Typography variant="myText">
                {t("modal.settings.middle")}
              </Typography>
            }
          />
          <FormControlLabel
            value={videoQty.height}
            control={<Radio />}
            label={
              <Typography variant="myText">
                {t("modal.settings.high")}
              </Typography>
            }
          />
        </RadioGroup>
  ...
  function getAudio() {
    ...
    return (
      <FormControl>
        ...
        >
          <FormControlLabel
            value={audioQty.enabled}
            control={<Radio />}
            label={
              <Typography variant="myText">
                {t("modal.settings.enabled")}
              </Typography>
            }
          />
          <FormControlLabel
            value={audioQty.disabled}
            control={<Radio />}
            label={
              <Typography variant="myText">
                {t("modal.settings.disabled")}
